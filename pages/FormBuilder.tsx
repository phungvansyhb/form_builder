...
export default function FormBuilder({}: Props) {
    const [inputConfigs, setInputConfig] = useState<InputConfig[] | []>([
        { id: 1, name: "name", hidden: false, disable: false ,  type : TYPEINPUT.TEXTINPUT, defaultValue:'Sypv' , label : 'Tên' , layout : 12 },
        { id: 2, name: "dob", hidden: false, disable: false ,  type : TYPEINPUT.DATE, defaultValue:'1999-06-26', label: "Ngày sinh" , layout : 6 } ,
        { id: 3, name: "hobbies", hidden: false, disable: false  ,  type : TYPEINPUT.SELECT, defaultValue:'bong da' , label : "Sở thích" , layout : 12},
    ]);
